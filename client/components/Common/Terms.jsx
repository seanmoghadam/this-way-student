...
export default class Loading extends React.Component {
    ...
    render() {
        ...
        return <div id={"Terms"} className="contentContainer">
            <h2>Terms & Conditions</h2>
            <p>These terms and conditions outline the rules and regulations for the use of ThisWay's Website.</p> <br/>
            <span> ThisWay</span> is located at:<br/>
            <address>Wienerstraße Inner City, Vienna<br/>Vienna - 1020, Austria<br/>
            </address>
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                ...
                law
                of Austria. Any use of the above terminology or other words in the singular, plural,
                capitalisation and/or he/she or they, are taken as interchangeable and therefore as referring to
                same.</p><h2>Cookies</h2>
            <p>We employ the use of cookies. By using ThisWay's website you consent to the use of cookies
                in accordance with ThisWay’s privacy policy.</p><p>Most of the modern day interactive web sites
            use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
            to enable the functionality of this area and ease of use for those people visiting. Some of our
            affiliate / advertising partners may also use cookies.</p><h2>License</h2>
            <p>Unless otherwise stated, ThisWay and/or it’s licensors own the intellectual property rights for
                all material on ThisWay. All intellectual property rights are reserved. You may view and/or print
                pages from https://wwwThis-Way.guide for your own personal use subject to restrictions set in these
                terms and conditions.</p>
            <p>You must not:</p>
            <ol>
                <li>Republish material from https://wwwThis-Way.guide</li>
                <li>Sell, rent or sub-license material from https://wwwThis-Way.guide</li>
                <li>Reproduce, duplicate or copy material from https://wwwThis-Way.guide</li>
            </ol>
            <p>Redistribute content from ThisWay (unless content is specifically made for redistribution).</p>
            <h2>User Comments</h2>
            <ol>
                <li>This Agreement shall begin on the date hereof.</li>
                <li>Certain parts of this website offer the opportunity for users to post and exchange opinions,
                    information,
                    material and data ('Comments') in areas of the website. ThisWay does not screen, edit, publish
                    or review Comments prior to their appearance on the website and Comments do not reflect the views or
                    opinions ofThisWay, its agents or affiliates. Comments reflect the view and opinion of the
                    person who posts such view or opinion. To the extent permitted by applicable laws ThisWayshall
                ...
                <li>ThisWayreserves the right to monitor all Comments and to remove any Comments which it considers
                ...
                <li>You hereby grant to <strong>ThisWay</strong> a non-exclusive royalty-free license to use, reproduce,
            ...
            <p>We will approve link requests from these organizations if we determine that: (a) the link would not
                ...
                the visibility associated with the hyperlink outweighs the absence of ThisWay and (d) where the
            ...
            <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our
                website,
                you must notify us by sending an e-mail to <a href="mailto:thisway@office.guide"
                                                              title="send an email to thisway@office.guide">thisway@office.guide</a>.
            ...
            <p>No use of ThisWay’s logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
            <h2>Iframes</h2>
